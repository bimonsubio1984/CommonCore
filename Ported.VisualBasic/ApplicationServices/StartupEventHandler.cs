...
// Type: Ported.VisualBasic.ApplicationServices.StartupEventHandler
...
namespace Ported.VisualBasic.ApplicationServices
{
  ...
  /// <param name="e">A <see cref="T:Ported.VisualBasic.ApplicationServices.StartupEventArgs" /> object that contains the event data.</param>
